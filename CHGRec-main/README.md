# CHGRec: Causal Heterogeneous Graph-enhanced Medication Recommendation with Personalized Refinement
...
- `src` contains the code for starting the program.
- `model` contains the core code for the model.
